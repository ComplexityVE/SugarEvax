...
class Agent:
	...
	def __init__(self, loc, taxation, params):
		...
		# choose attributes
		self.vision = np.random.random_integers(1,max_vision)
	...
	def calculate_tax(self):
		...
		if self.sugar < 5:
			...
			self.tax = 1.5 + ((self.sugar*.4-5))
		elif self.sugar >=12 and self.sugar < 20:
			self.tax = 4.8 + ((self.sugar*.5-12))
		else:
			self.tax = 10 + ((self.sugar*.6-20))
		"""
