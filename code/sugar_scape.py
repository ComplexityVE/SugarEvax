...
class Sugarscape(Cell2D):
	...
	def add_agent(self):
		...
		returns: new Agent
		"""
		new_agent = Agent(self.random_loc(), self.taxation, self.params)
...
if __name__ == '__main__':
	...
	for l in range(10):
		...
		for i in range(800):
			env.step()
		total_pops.append(env.agent_count_seq)
		print(l)
		av_pops= np.mean(total_pops, axis=0)
		plt.plot(av_pops)
